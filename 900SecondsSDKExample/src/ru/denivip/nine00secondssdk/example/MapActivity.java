...
import ru.denivip.location.LocatorCallback;
import ru.denivip.nine00secondssdk.Nine00SecondsSDK;
import ru.denivip.nine00secondssdk.Nine00SecondsSDK.RequestErrorType;
import ru.denivip.nine00secondssdk.data.StreamData;
import ru.denivip.nine00secondssdk.example.map.Nine00ClusterMarker;
import ru.denivip.nine00secondssdk.example.map.Nine00MarkerRenderer;
...
public class MapActivity extends Activity implements OnMapReadyCallback, OnClusterClickListener<Nine00ClusterMarker>, OnClusterItemClickListener<Nine00ClusterMarker> {
	...
	protected void requestStreams() {
		Nine00SecondsSDK.requestStreamsList(new Nine00SecondsSDK.RequestStreamsListCallback() {
			...
			@Override
			public void onComplete(final ArrayList<StreamData> streams) {
